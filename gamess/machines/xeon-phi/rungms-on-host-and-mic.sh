...
##############################################################
#  Usage: This script will allow you to run GAMESS in        #
#         symmetric mode:                                    #
#  n-compute processes on host + n-compute process on mic(s) #
#                                                            #
#  The number of mic nodes utilized is dependent on the      #
#  the values of NCPU and PPN:                               #
#  NCPU/PPN=1 (host only)                                    #
#  NCPU/PPN=2 (host + 1 mic)                                 #
#  NCPU/PPN=N (host + n-1 mic)                               #
#                                                            #
#  mic binary must be named gamess.$VERNO.x.mic              #
##############################################################
...
#  Specify available mic nodes by name - does not appear to work on CyEnce
#miccards[0]=mic0
#miccards[1]=mic1

#  Or specify via IPs - preferred approach on CyEnce
miccards[0]=172.16.31.1
miccards[1]=172.16.32.1

# MIC version will run gamess.$VERNO.x.mic
