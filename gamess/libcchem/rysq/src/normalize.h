...
#define RYSQ_NORMAL_100 1.0 /**< @brief (1 0 0) normalization constant */
#define RYSQ_NORMAL_200 1.0 /**< @brief (2 0 0) normalization constant */
#define RYSQ_NORMAL_110 sqrt(3) //1.73205080757 /**< @brief (1 1 0) normalization constant */
#define RYSQ_NORMAL_300 1.0 /**< @brief (3 0 0) normalization constant */
#define RYSQ_NORMAL_210 sqrt(5) //2.2360679775 /**< @brief (2 1 0) normalization constant */
#define RYSQ_NORMAL_111 sqrt(3)*sqrt(5) //3.87298334621 /**< @brief (1 1 1) normalization constant */
#define RYSQ_NORMAL_400 1.0 /**< @brief (4 0 0) normalization constant */
#define RYSQ_NORMAL_310 sqrt(7) //2.64575131106 /**< @brief (3 1 0) normalization constant */
#define RYSQ_NORMAL_220 sqrt(7)*sqrt(5)/sqrt(3) //3.41565025532 //3.31662479036 /**< @brief (2 2 0) normalization constant */
#define RYSQ_NORMAL_211 sqrt(7)*sqrt(5) //5.9160797831 /**< @brief (2 1 1) normalization constant */
