...
#ifndef LIBCCHEM_RYSQ_SRC_KERNEL_TWOC_RECURRENCE_HPP_
#define LIBCCHEM_RYSQ_SRC_KERNEL_TWOC_RECURRENCE_HPP_
...
#endif /* LIBCCHEM_RYSQ_SRC_KERNEL_TWOC_RECURRENCE_HPP_ */
